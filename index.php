		...
		<div class="main">
            <div class="login">
            	<form action="register.php" method="POST">
            		...
            		<input type="password" placeholder="password" class="form-control" name="pass" required><br><br>
            		<input type="password" placeholder="confirm password" class="form-control" name="cpass" required><br><br>
